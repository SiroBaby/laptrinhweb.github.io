...
<body class="body">
    <div class="header">
     ...
     <div class="row1">Admin/ Quản Lý Kho Sản Phẩm/ Thêm Sản Phẩm</div>
    <div class="contents">
        <form method="post" action="themsanpham_1.php" enctype="multipart/form-data" class="form">
            <legend id="legend"><h2>Thêm Sản Phẩm</h2></legend>
            ...
            <input type="text" id="dotinhkhiet" name="dotinhkhiet" value="" placeholder="Độ Tinh Khiết" required size="50"><br>
            ...
            <input type="file" id="hinh" name="hinh" required accept="image/*"><br><br>
